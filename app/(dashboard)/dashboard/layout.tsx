  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-68px)] max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-1 overflow-hidden h-full">
        {/* Sidebar */}
        <aside
          className={`w-64 bg-white dark:bg-gray-950 lg:bg-gray-50 dark:lg:bg-gray-900 border-r border-gray-200 dark:border-gray-800 lg:block ${isSidebarOpen ? 'block' : 'hidden'
            ...
            {navItems.map((item) => (
              <Link key={item.href} href={item.href} passHref>
                <Button
                  ...
                  className={`shadow-none my-1 w-full justify-start transition-all duration-200 ${pathname === item.href
                    ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 hover:bg-orange-200 dark:hover:bg-orange-900/50'
                    : 'hover:bg-gray-100 dark:hover:bg-gray-800 hover:shadow-md dark:text-gray-300'
                    }`}
